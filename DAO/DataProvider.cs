...
namespace DAO
{
    public class DataProvider
    {
        ...
        private readonly string _connString = "Data Source=.;Initial Catalog=HotelManagement;Integrated Security=True";
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public int ExecuteNonQueryAsync(string query, object[] parameters = null)
        {
            var count = 0;
