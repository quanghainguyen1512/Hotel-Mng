...
namespace WpfApp1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class STUDENTDataTable : global::System.Data.TypedTableBase<STUDENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public STUDENTRow AddSTUDENTRow(string Name, int ClassId) {
    ...
    public partial class STUDENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[STUDENT] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 A" +
                "ND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ClassId = 1 AND [" +
                "ClassId] IS NULL) OR ([ClassId] = @Original_ClassId)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[STUDENT] ([Name], [ClassId]) VALUES (@Name, @ClassId);\r\nSELECT" +
                " Id, Name, ClassId FROM STUDENT WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[STUDENT] SET [Name] = @Name, [ClassId] = @ClassId WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_ClassId = 1 AND [ClassId] IS NULL) OR ([ClassId] = @Original_ClassId)));
SELECT Id, Name, ClassId FROM STUDENT WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfApp1.Properties.Settings.Default.TESTConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, ClassId FROM dbo.STUDENT";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, global::System.Nullable<int> Original_ClassId) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> ClassId, int Original_Id, string Original_Name, global::System.Nullable<int> Original_ClassId, int Id) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> ClassId, int Original_Id, string Original_Name, global::System.Nullable<int> Original_ClassId) {
            return this.Update(Name, ClassId, Original_Id, Original_Name, Original_ClassId, Original_Id);
        }
    }
